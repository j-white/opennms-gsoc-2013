...
/**
 * <p>ClusterScheduler interface.</p>
 *
 * @author ranger
 * @author jwhite
 * @version $Id: $
 */
public interface ClusterScheduler extends ClusterScheduleTimer {
         ...
         */
        @Override
        public abstract void schedule(long interval, final ClusterRunnable runnable);
