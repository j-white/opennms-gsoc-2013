 ...
 * 
 * If an instance is elected leader after trying to acquire the lock
 * for some period of time, the leader thread will sleep before
 * starting any of the services. This allows the cluster to shutdown/restart
 * cleanly without bouncing the services around.
 * 
 * @author jwhite
 */
public class Clusterd extends AbstractServiceDaemon implements
    ...
    public void takeLeadership() {
        ...
        LOG.debug("Starting {} services.", servicesToStart.size());
