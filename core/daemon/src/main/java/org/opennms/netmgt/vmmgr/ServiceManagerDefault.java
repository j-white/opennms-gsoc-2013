...
public class ServiceManagerDefault implements ServiceManager {
    ...
    public void start(final List<Service> servicesToStart,
        ...
        // All of the services were successfully started, add them to the registry
        for (Service service : servicesToStart) {
            LOG.debug("Succesfully started " + service.getName());
            ServiceRegister.getInstance().addService(service);
        }
    }
